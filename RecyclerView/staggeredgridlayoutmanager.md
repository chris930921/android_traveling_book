```java
 private Activity activity;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // 非固定格狀佈局，每一列或欄的高度、寬度都不同。
        // 第一個參數是一列或一欄多少元件。
        // 第三個參數是設定列表滑動方向是 垂直Vertial(填滿列) 或 水平Horizontal(填滿欄)。
        StaggeredGridLayoutManager linearManager = new StaggeredGridLayoutManager(3, StaggeredGridLayoutManager.VERTICAL);
...
```java
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // 第一個參數是一列或一欄多少元件。
        // 第三個參數是設定列表滑動方向是 垂直Vertial(填滿列) 或 水平Horizontal(填滿欄)。
        StaggeredGridLayoutManager linearManager = new StaggeredGridLayoutManager(3, StaggeredGridLayoutManager.HORIZONTAL);
